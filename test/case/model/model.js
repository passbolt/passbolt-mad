...
describe("mad.Model", function () {
    ...
    it("should be updated when a property change has been detected", function() {
        var usersList = mad.test.model.UserTestModel.findAll().then(function(data) {
            //var usersList = new can.List(data);
            //console.log(usersList);
            var usersCanList = new can.List(data);
            usersCanList.bind('change', function() {
                console.log('an element changed');
                console.log(usersCanList);
            });
            usersCanList.bind('add', function() {
                console.log('an element has been added');
                console.log(usersCanList);
            });
            var user = mad.test.model.UserTestModel.findOne().then(function(data) {
                console.log('findOne', data);
                console.log(usersCanList);
                //usersCanList.attr(2, data);
            });
        }).fail(function(data) {
