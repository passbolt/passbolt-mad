 ...
 */
const ControlHelper = Control.extend('mad.helper.Control', /** @static */ {
  ...
  getViewPath: function(Control) {
    ...
    const viewName = StringUtil.underscore(split.pop());
